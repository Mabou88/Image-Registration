...
void Filtre::filtrepassehaut(){
	...
	gausfiltre->SetInput(imagefiltre);
	gausfiltre->SetVariance(1);
	gausfiltre->SetMaximumKernelWidth(5);
	gausfiltre->Update();
  ...
  writer0->SetFileName( "C:/Users/Marc-Antoine/Documents/Imagecode/output/gaussienne.nii");
  writer0->SetInput(imagegaus);
  writer0->Update();
...
void Filtre::sauvegardeimage(){
  ...
  writer->SetImageIO(ioimagenifti);
  writer->SetFileName( "C:/Users/Marc-Antoine/Documents/Imagecode/output/resultconvolution.nii");
