...
namespace itk
{
    ...
    public:
        ...
        void setLiverMask(MaskType::Pointer Mask);
        ...
        MaskType::Pointer TransformMask(const TransformParametersType &parameters,int ind) const;
        typename TMovingImage::Pointer TransformImage(const TransformParametersType &parameters, int ind) const;
