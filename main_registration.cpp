...
//************************************************************************* 
  ...
  //*************************************************************************
	...
	crane.regioninferieur(60);

	//int largueurus=crane.getlargueur();
	//cout<<"largueur_us"<<largueurus<<endl;
	/*
  ...
  //*************************************************************************
	...
	*/
	...
	int largueurirm=crane2.getlargueur();
	cout<<"largueur irm"<<largueurirm<<endl;
  ...
  //*************************************************************************
	...
	Roi_crane volumeirm(US_shrunk);
	volumeirm.setdim();
	volumeirm.regioninferieur(70);
  ...
  //*************************************************************************
	...
	scalefactortransform[0]=1.2;
	scalefactortransform[1]=1.2;
	scalefactortransform[2]=1.2;
	...
	//translate
		 ...
		 vecteurtranslation_x_scale=vecteurtranslation_x_scale*-15;
		 vecteurtranslation_y_scale=vecteurtranslation_y_scale*-15;
		 vecteurtranslation_z_scale=vecteurtranslation_z_scale*-15;
